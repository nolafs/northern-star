...
export default function Page(props: PageProps) {
  return (
    <div className={'mx-auto max-w-4xl text-primary prose lg:prose-xl  text-primary'}>
      <h1>Cookie Policy</h1>
      <p>At Northern Star Game Ltd., we value your privacy and strive to be transparent about the data we collect and
      ...
      <p>If you have any questions about our Cookie Policy, please contact us at <a
        href="mailto:contact@northernstargame.com">contact@northernstargame.com</a>.</p>
